...
export const helpArticles: HelpArticle[] = [
  {
    ...
    description:
      'Set up your first site and understand how Siloq helps your business get found online.',
    icon: 'Rocket',
...
**Three-Layer Model** — Siloq's framework: GEO + SEO + CRO. Every piece of content should serve all three.`,
  },
  {
    ...
    description:
      'The routine that gets results — consistent small actions beat occasional marathons.',
    icon: 'ListChecks',
