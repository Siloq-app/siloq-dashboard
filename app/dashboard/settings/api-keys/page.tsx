  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0f172a] to-[#1e293b] p-8">
      <div className="mx-auto max-w-4xl">
        <div className="mb-8">
          <h1 className="mb-2 text-3xl font-bold text-slate-100">API Keys</h1>
        ...
        <Card className="mb-8 border-slate-700/50 bg-slate-900/80">
          <CardHeader>
          ...
          <CardContent>
            ...
            <div className="flex gap-4">
              <div className="flex-1">
                <Label htmlFor="keyName" className="mb-2 block text-slate-300">
        ...
        <Card className="mt-8 border-slate-700/50 bg-slate-900/80">
          <CardHeader>
          ...
          <CardContent>
            <ol className="list-inside list-decimal space-y-3 text-slate-300">
              ...
              <li>
                Go to <strong>Settings → Siloq</strong> in your WordPress admin
              </li>
