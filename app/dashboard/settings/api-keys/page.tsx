...
export default function ApiKeysPage() {
  ...
  const revokeMasterKey = async (keyId: string) => {
    if (
      !confirm('Are you sure you want to revoke this master key? This action cannot be undone.')
    ) {
      return;
    }
    try {
                ...
                <Card className="border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900">
                  <CardHeader className="p-4 sm:p-6">
                    ...
                    <CardDescription className="text-sm text-slate-500 dark:text-slate-400">
                      A master key works across all your sites. When you install the WordPress
                      plugin and connect with a master key, Siloq automatically creates the site for
                      you.
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="p-4 pt-0 sm:p-6 sm:pt-0">
                    <div className="flex flex-col gap-4 sm:flex-row">
                      ...
                      <div className="flex items-end">
                        <Button
                          ...
                          className="w-full bg-gradient-to-r from-blue-500 to-indigo-500 text-white hover:from-blue-600 hover:to-indigo-600 sm:w-auto"
                        >
                          {isGeneratingMaster ? (
                            <>
                    ...
                    {newlyCreatedMasterKey && (
                      <div className="mt-6 rounded-md border border-amber-500/50 bg-amber-500/5 p-4">
                        ...
                        <p className="mb-2 mt-1 text-sm text-amber-700 dark:text-amber-300">
                      ...
                      masterKeys.length > 0 && (
                        <div className="mt-6 space-y-3">
                          ...
                          {masterKeys.map((mk) => (
                            <div
                              key={mk.id}
                              className="flex flex-col justify-between gap-3 rounded-lg border border-slate-200 bg-slate-50 p-4 dark:border-slate-700/50 dark:bg-slate-800/50 sm:flex-row sm:items-center"
                            >
                              <div className="min-w-0 flex-1">
                                <div className="mb-1 flex flex-wrap items-center gap-2">
                                  ...
                                  <span className="rounded bg-[#006ff9]/10 px-2 py-0.5 text-[10px] font-medium text-[#006ff9] dark:text-[#66a5ff]">
                                    Master
                                  </span>
                                </div>
                              ...
                              <Button
                                ...
                                className="self-start text-red-400 hover:bg-red-500/10 hover:text-red-300 sm:self-center"
                              >
                  ...
                  <CardContent className="p-4 pt-0 sm:p-6 sm:pt-0">
                    ...
                    {sites.length === 0 && (
                      <div className="mb-4 rounded-md border border-amber-200 bg-amber-50 p-4 text-sm text-amber-800 dark:border-amber-800 dark:bg-amber-950 dark:text-amber-200">
                        <strong>No sites found</strong> — You need to create a site first before
                        generating API keys.{' '}
                  ...
                  <CardContent className="p-4 pt-0 sm:p-6 sm:pt-0">
                    {isLoading ? (
                      ...
                      <div className="py-8 text-center">
                        <Key className="mx-auto mb-3 h-12 w-12 text-slate-400 opacity-50" />
                ...
                <Card className="border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900">
                  ...
                  <CardContent className="p-4 pt-0 sm:p-6 sm:pt-0">
                    ...
                    <div className="mt-4 rounded-md border border-blue-200 bg-blue-50 p-4 text-sm text-blue-800 dark:border-blue-800 dark:bg-blue-950 dark:text-blue-200">
                      <strong>Tip:</strong> Create separate API keys for production and staging
