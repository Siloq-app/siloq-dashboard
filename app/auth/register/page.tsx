            ...
            <div className="grid gap-6">
              ...
              <form onSubmit={handleSubmit}>
                <div className="flex flex-col gap-6">
                  ...
                  <div className="grid gap-2">
                    ...
                    <div className="relative flex items-center">
                      ...
                      <button
                        ...
                        className="absolute right-0 top-0 h-full px-3 flex items-center justify-center text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 rounded-r-md"
                        tabIndex={-1}
                      >
                  ...
                  <Button type="submit" className="w-full" disabled={isLoading || !formData.name || !formData.email || !formData.password || !formData.confirmPassword}>
                    {isLoading ? (
                      <>
