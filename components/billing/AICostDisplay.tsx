...
export function AICostDisplay({
  ...
  return (
    <div
      className={`rounded-lg border border-slate-200 bg-slate-50 p-4 dark:border-slate-700 dark:bg-slate-800/50 ${className}`}
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-slate-600 dark:text-slate-400">{costMessage}</p>
          ...
          {/* Trial info */}
          {estimate.billingMode === 'trial' &&
            trialPagesUsed !== undefined &&
            trialPagesLimit !== undefined && (
